...
const ProductTableList = () => {
  ...
  const fakeUsers: IUserResponse[] = [
    ...
    },
    {
      ...
      isFirstLogin: true,
      isUse: true,
      profileImage: "/images/profile/user-2.jpg",
      roleId: 2,
      roleLabel: "매니저",
      controlStatus: 1,
      createdAt: "2024-01-02 18:20:52",
    },
    {
      ...
      isFirstLogin: true,
      isUse: false,
      profileImage: "/images/profile/user-3.jpg",
      roleId: 3,
      roleLabel: "어노테이터",
      controlStatus: 2,
      createdAt: "2024-01-02 18:20:52",
  ...
  const [rows, setRows] = React.useState(fakeUsers);
  const [search, setSearch] = React.useState("");

  const handleSearch = (event: React.ChangeEvent<HTMLInputElement>) => {
    const filteredRows: IUserResponse[] = fakeUsers.filter((row) => {
